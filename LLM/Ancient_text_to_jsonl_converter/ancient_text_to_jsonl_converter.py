    ...
    with open(output_file, 'w', encoding='utf-8') as out_file:
        for file_path in root_path.rglob('bitext.txt'):
            ...
            for ancient, modern in pairs:
                data = {
                    "instruction": f"你是一位精通中国古代文学和现代汉语的语言专家。你的任务是将给定的古文段落准确翻译成现代汉语，保持原文的意思和风格，同时使用当代读者容易理解的语言。请注意以下几点：1.保持原文的核心意思和情感。2.使用现代汉语的语法结构和表达方式。3.选择恰当的现代词汇来表达古文中的概念。4.如果有些词语或概念在现代没有直接对应，请提供简短的解释。5.保持文学性和优雅度，但优先考虑清晰度和可读性。6.如果原文中有特殊的修辞手法或文学设备，尽量在现代文中体现出来。请将以下{source}中的古文翻译成现代文：",
                    "input": ancient,
                    "output": modern
                }
